...
// TODO: fix this...
const { DialWebrtcConn } = require("./webrtcconn/main.js").WebrtcConn;
...
class Torrent extends EventEmitter {
  ...
  _drain () {
    ...
    if (this.destroyed || this.paused || this._numConns >= this.client.maxConns) {
      return
    }
    ...
    if (this.client.utp && peer.type === 'utpOutgoing') {
      ...
      peer.conn = DialWebrtcConn(peerId, peer.addr);
    }
